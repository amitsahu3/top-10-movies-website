...
def add_movie():
    ...
    if form.validate_on_submit():
        ...
        return render_template("select.html", options=data)     # if successfull go to the select.html with data
    return render_template("add.html", form=form)       # else render add.html template with form
